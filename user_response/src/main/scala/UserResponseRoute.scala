...
import com.typesafe.scalalogging.Logger
import keepid.common.authentication.RequestAuth
import keepid.common.client_database.{ClientDatabase, DBRequestManager}
import keepid.common.constants.{Domain, HttpPaths}
import keepid.common.message_broker.{Producer, Topics}
import keepid.services.user_response.{ResponseType, UserIdManagerJsonProtocol, UserResponseAcceptForwardData, UserResponseAcceptReceiveData, UserResponseRejectReceiveData, UserResponseReportReceiveData}
